# Evaluation synthetic_irc_120_mmr
...
- conservation_R_numeric_mean: 0.266667
- conservation_R_temporal_mean: 0.000000
- conservation_faithfulness_mean: 0.594444
- evaluate_seconds: 0.000175
...
- retrieve_seconds: 0.010527

## Reproduction

- `python -m pip install -e '.[dev]'`
- `rag-run-benchmark --config configs/benchmark.yaml`
- `rag-evaluate --config configs/eval.yaml  # set run_dir to 2a6ba3cd1390`
