...
- conservation_faithfulness_mean: 0.870370
- evaluate_seconds: 0.000034
...
- retrieve_seconds: 0.001152

## Reproduction

- `python -m pip install -e '.[dev]'`
- `rag-run-benchmark --config configs/benchmark.yaml`
- `rag-evaluate --config configs/eval.yaml  # set run_dir to 3606460d30bb`
